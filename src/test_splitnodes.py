...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_exatract_markdown_links(self):
    ...
    def test_text_to_textnodes(self):
        ...
        nodes = text_to_textnodes("This is **bold** text with an _italic_ word, a `code block`, a [link](https://example.com), and an ![image](https://i.imgur.com/zjjcJKZ.png)")
        self.assertListEqual(
            [
